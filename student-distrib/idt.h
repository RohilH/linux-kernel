...
int (*interruptHandler[32])(void) = {DIVISION_ERROR_HANDLER, SINGLE_STEP_INTERRUPT_HANDLER, NMI_HANDLER, BREAK_POINT_HANDLER,
                                    ...
                                    VIRTUALIZATION_EXCEPTION_HANDLER, CONTROL_PROTECTION_EXCEPTION_HANDLER_ ROI_HANDLER};
